...
\\
The ECAL barrel cover the pseudorapidity range $|\eta|<1.479$ it consist of about $61200$ $\mathrm{PbWO}_4$ crystal while the endcaps cover the pseudorapidity range $1.479<|\eta|<3.0$. This was build in order to have a resolution able to discriminate the two gamma in the Higgs boson decay $H^0\,\rightarrow\,\gamma\gamma$ 
\\
The HCAL, instead, the barrel cover the pseudorapidity range $|\eta|<1.3$ while the endcaps $1.3<|\eta|<3.0$ this detectors are really important in the hadronic jet reconstruction. 
\\
