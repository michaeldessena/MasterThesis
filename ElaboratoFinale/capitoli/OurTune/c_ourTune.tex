...
\\
As an example, in \figRef{fig:param_vs_distributions} it is clear that the model is more sensitive to the parameter \texttt{MultipartonInteractions:pT0Ref} (top) respect to 
