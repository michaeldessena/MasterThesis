...
\begin{enumerate}
	...
	\item Only one of the two partons has already been scattered (\figRef{fig:Rescattering} middle); 
%	In very rough terms, this means that the non-diffractive
%cross-section is saturated by more than a single partonic scattering and that the number of partonic
%interactions is determined by a Poisson distribution. This model, which was originally proposed in has been very successful in the description of many experimental measurements at hadron colliders.
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=12cm]{{img/PartonShower_pT.png}}
...
\section{Primordial $k_T$ and Color reconnection in\\ \mbox{PYTHIA8}}
