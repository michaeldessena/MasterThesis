...
\noindent The PerBin Model minimization results are displayed in \figRef{fig:result_PerBin_PrimordialkT_1}
...
The Inverse model distribution of prediction is reported in \figRef{fig:}
...
\end{tabular}
\caption{Results obtained from the PerBin and the Inverse model in the }
